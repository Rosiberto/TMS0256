...
<head>
  ...
  <body>
    ...
    <div class="tela_cadastro">
        <form action="validate_registro_empresa.php" method="post">
          <fieldset class="grupo">
              <!-- Campo do Nome -->
              <div class="campo">
                  <label for="nome"><strong>Nome</strong></label>
                  <input type="text" name="nome" id="nome" placeholder="Nome da empresa" required>
              </div>
              <div class="campo">
                <label for="nome"><strong>Categoria</strong></label>
                <input type="text" name="categoria" id="nome" placeholder="Categoria" required>
            </div>
          </fieldset>   
      ...
      <fieldset class="grupo">
          ...
          <div class="campo">
              ...
              <input type="cpf" name="endereco" id="endereco" placeholder="Informe o Endereço" required>
          </div>
