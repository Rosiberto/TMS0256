        ...
        <h1 class="">Vai pra onde ?</h1>        
            <div class="d-flex mt-3 align-items-center">
              ...
              <datalist id="datalistOptions">
                ...
                <input type="date" class="form-control form-control-lg m-2 fs-4" id="Dt_inicial" name = "Dt_Entrada" value="empty">
              
                <p class="mt-3 fs-3">Saída: </p>
                <input type="date" class="form-control form-control-lg m-2 fs-4" id="Dt_final"  name = "Dt_Saida">
              
                
              <input class="form-control form-control-lg m-2 fs-4" id="Capacidade_Pessoa" name = "Capacidade_Pessoa " type="text" placeholder="Quantos quartos">
