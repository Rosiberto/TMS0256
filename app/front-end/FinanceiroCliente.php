...
.tela_cadastro {
  ...
  <body>
    ...
    <nav class="navbar d-flex justify-content-evenly border fs-3">
      ...
      <div class="btn-group" role="group">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a class="dropdown-item fs-4" href="http://localhost/TMS0256/app/backend/logout" onclick="">Sair</a></li> 
        </ul>
      </div>
    </nav>
    ...
    <div class="tela_cadastro">
        <form action ="http://localhost/TMS0256/app/backend/cartao/novo" method = "post">
          ...
          <div class="campo">
              ...
              <input type="text" name="validade" id="validade" placeholder="01/2024" required>
          </div>  
      </fieldset>  
