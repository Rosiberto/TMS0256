...
<head>
  ...
  <body>
    ...
    <div class="tela_cadastro">
        <form>
          <div class="campo">
            <label for="Quarto_Desejado"><strong>Quarto Desejado</strong></label>
            <input type="text" name="Quarto_Desejado<" id="Quarto_Desejado<" placeholder="301" required>
          </div>
          <button class="botao" type="submit" onsubmit="">Procurar Quarto</button> 
          <fieldset class="grupo">
              <!-- Campo da atualização do Serviço -->
              <div class="campo">
                <label for="Quantidade_Pessoas"><strong>Quantidade de Pessoas</strong></label>
                <input type="text" name="Quantidade_Pessoas" id="Quantidade_Pessoas" placeholder="5" required>
                ...
                <label for="Dt_Saída"><strong>Data de Saída</strong></label>
                <input type="text" name="Dt_Saida" id="Dt_Saida" placeholder="30/05/2024" required>
              </div>              
          </fieldset> 
          <fieldset class="grupo">
          <div class="campo">
              <label for="Servico_Solicitado"><strong>Serviço Solicitado</strong></label>
          ...
          <button class="botao" type="submit" onsubmit="">Efetuar Reserva</button>            
        </form>
    </div>
