        ...
        <div class="row mt-4">
            ...
            <div class="col-md-3">
                <div class="card text-white bg-warning mb-3">
                    ...
                    <div class="card-body">
                        <h5 class="card-title" id="maintenanceRooms">0</h5>
                        <p class="card-text">Quartos em manutenção.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card text-white bg-info mb-3">
                    ...
                    <div class="card-body">
                        <h5 class="card-title" id="averagePrice">R$0</h5>
                        <p class="card-text">Preço médio por noite.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function updateIndicators() {
            ...
            roomTableBody.querySelectorAll('tr').forEach(row => {
                // Obtém o status e o preço do quarto
                ...
                // Soma os preços dos quartos para calcular o preço médio
                totalPrice += price;
                totalRooms++;
            });
            ...
            document.getElementById('maintenanceRooms').textContent = maintenanceCount;
            document.getElementById('averagePrice').textContent = `R$${(totalPrice / totalRooms).toFixed(2)}`;
        }
